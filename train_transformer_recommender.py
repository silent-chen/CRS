...
import config
from models.transformer_recommender_model import Recommender
...
if __name__ == '__main__':
    params_seq = [(config.TRANSFORMER_RECOMMENDER_MODEL, test_params.transformer_recommender_params, test_params.train_recommender_params)]
