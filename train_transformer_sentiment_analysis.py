...
import config
from models.transformer_sentiment_analysis import SentimentAnalysis, SentimentAnalysisLoss
...
if __name__ == '__main__':
    params_seq = [(config.TRANSFORMER_SENTIMENT_ANALYSIS_MODEL, test_params.transformer_sentiment_analysis_params, test_params.train_sa_params)]
